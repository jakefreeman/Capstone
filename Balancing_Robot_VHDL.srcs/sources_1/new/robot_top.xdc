...
set_property PACKAGE_PIN B13 [get_ports SerIn]					
	set_property IOSTANDARD LVCMOS33 [get_ports SerIn]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
#set_property PACKAGE_PIN F14 [get_ports {JA[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JA[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports trigger_out1]					
	set_property IOSTANDARD LVCMOS33 [get_ports trigger_out1]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports sensor_in1]					
...
set_property PACKAGE_PIN D18 [get_ports trigger_out2]					
	set_property IOSTANDARD LVCMOS33 [get_ports trigger_out2]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports sensor_in2]					
...
set_property PACKAGE_PIN G14 [get_ports motor1_out_A]					
	set_property IOSTANDARD LVCMOS33 [get_ports motor1_out_A]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports motor1_out_B]					
	set_property IOSTANDARD LVCMOS33 [get_ports motor1_out_B]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports motor2_out_A]					
	set_property IOSTANDARD LVCMOS33 [get_ports motor2_out_A]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports motor2_out_B]					
	set_property IOSTANDARD LVCMOS33 [get_ports motor2_out_B]
...
#set_property PACKAGE_PIN K2 [get_ports pwm_out]					
	#set_property IOSTANDARD LVCMOS33 [get_ports pwm_out]
##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
#set_property PACKAGE_PIN E7 [get_ports dir_1_out]					
	#set_property IOSTANDARD LVCMOS33 [get_ports dir_1_out]
##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
#set_property PACKAGE_PIN J3 [get_ports dir_2_out]					
	#set_property IOSTANDARD LVCMOS33 [get_ports dir_2_out]
...
set_property PACKAGE_PIN H4 [get_ports Rx]					
	set_property IOSTANDARD LVCMOS33 [get_ports Rx]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
set_property PACKAGE_PIN H1 [get_ports CTS]					
