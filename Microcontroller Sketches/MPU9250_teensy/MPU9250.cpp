...
void MPU9250::initMPU9250()
{
  ...
  // Set I2C clock to fastest setting
  writeByte(MPU9250_ADDRESS, I2C_MST_CTRL, 0x09);
...
// Changing Gyro bandwidth filter to 250 Hz for better less delay
// TODO: See how the noise affects gyro data
...
// Changing the rate divider for a higher sample rate, should be 1 kHz/(1+0) = 1kHz
...
// Changing scale for full sensitivity, may have more noise
  c = c | Gscale << 0; // Set full scale range for the gyro
...
// set this to 00 for best sensitivity, may be noisier
  c = c | Ascale << 0; // Set full scale range for the accelerometer
